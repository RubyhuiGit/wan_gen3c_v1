...
def wan_parser():
    ...
    parser.add_argument("--video_sample_stride", type=int, default=2, help="Video sample stride.")
    parser.add_argument("--video_sample_n_frames", type=int, default=81, help="Number of video sample frames.")
