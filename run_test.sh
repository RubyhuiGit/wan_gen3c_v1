# pip install -U git+https://github.com/huggingface/transformers  transformers-4.57.0.dev0

accelerate launch examples/wanvideo/model_training/train.py \
  --dataset_base_path /root/autodl-tmp/all \
  --dataset_metadata_path /root/autodl-tmp/all/metadata.csv \
  --height 480 \
  --width 832 \
  --dataset_repeat 100 \
