...
lora_params, adaptor_params = split_params("/root/autodl-tmp/diff_res/epoch-0.safetensors")
...
cache_index = [0, 80]     # 要指定用来创建3d cache的frame_index
test_info = Dataset10KTestInfo(test_path, cache_index).get_data_dict()
